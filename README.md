...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ldas-tools-ldasgen-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ldas-tools-ldasgen-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2597&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ldas-tools-ldasgen-feedstock?branchName=main">
          </a>
        </summary>
        <table>
...
Once the `conda-forge` channel has been enabled, `ldas-tools-ldasgen` can be installed with `conda`:
...
```
mamba install ldas-tools-ldasgen
```

It is possible to list all of the versions of `ldas-tools-ldasgen` available on your platform with `conda`:
...
```
mamba search ldas-tools-ldasgen --channel conda-forge
```
...
mamba repoquery search ldas-tools-ldasgen --channel conda-forge

# List packages depending on `ldas-tools-ldasgen`:
mamba repoquery whoneeds ldas-tools-ldasgen --channel conda-forge

# List dependencies of `ldas-tools-ldasgen`:
mamba repoquery depends ldas-tools-ldasgen --channel conda-forge
```
